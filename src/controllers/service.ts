...
// this method recieves an object type of 'BaseItem' as an argument, providing all the required values to define a new item in the store, except the item's 'id' 
